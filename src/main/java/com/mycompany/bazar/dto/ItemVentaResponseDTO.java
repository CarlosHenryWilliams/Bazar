...
public class ItemVentaResponseDTO {
    ...
    private ProductoVentaResponseDTOParaVenta producto;

    public ItemVentaResponseDTO(long idItemVenta, int cantidad, ProductoVentaResponseDTOParaVenta producto) {
